...
class AccountControllerAdmin extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        toastr()->success('Successfully', 'Tạo tài khoản thành công');
    ...
    public function update($id, Request $request)
    {
        ...
        toastr()->success('Successfully', 'Cập nhật tài khoản thành công');
        return redirect()->route('account.index');
    }
    public function destroy($id)
    {
        if (Auth::user()->id == $id) {
            toastr()->error('Unachievable', "Bạn không thể tự block chính mình");
            return redirect()->route('account.index');
        }
        User::where('id', $id)->delete();
        toastr()->success('Successfully', 'Tài khoản đã được block');
        return redirect()->route('account.index');
    }
    public function unblock($id)
    {
        User::where('id', $id)->restore();
        toastr()->success('Successfully', 'Tài khoản đã được huỷ block');
        return redirect()->route('account.index');
    }
    ...
    public function submitFormCreateStaff(Request $request)
    {
        ...
        $user->givePermissionTo($permission);
        toastr()->success('Successfully', 'Tạo tài khoản thành công');
        return redirect()->route('admin.account.createStaff');
    }
}