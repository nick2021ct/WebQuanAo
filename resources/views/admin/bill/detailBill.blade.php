                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-bottom-0">
                                            <p class="mb-0 fw-normal">{{ $billAddress->fullname }}</p>
                                        </td>
                                        <td class="border-bottom-0">
                            ...
                            <thead class="text-dark fs-4">
                                <tr>
                                    <th class="border-bottom-0" style="width: 25%;">
                                        <h6 class="fw-semibold mb-0">Email đặt hàng</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Loại Địa chỉ</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Mã bưu điện</h6>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
