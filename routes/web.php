...
Route::get('/login/google', [AccountController::class, 'redirectToGoogle'])->name('redirectToGoogle');
Route::get('/login/google/callback', [AccountController::class, 'callbackGoogle'])->name('callbackGoogle');
//Register
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/order-success/{id}',[OrderController::class,'orderSuccess'])->name('orderSuccess');

    Route::get('profile/personal-information',[ProfileController::class,'information'])->name('information');
    Route::put('profile/changeInfo',[ProfileController::class,'changeInfo'])->name('changeInfo');

    Route::get('profile/address',[ProfileController::class,'address'])->name('address');
    Route::post('profile/add-address',[ProfileController::class,'addAddress'])->name('addAddress');
    Route::put('profile/edit-address/{id}',[ProfileController::class,'editAddress'])->name('editAddress');
    Route::delete('profile/delete-address/{id}',[ProfileController::class,'deleteAddress'])->name('deleteAddress');

    Route::get('profile/password',[ProfileController::class,'password'])->name('password');
    Route::put('profile/change-pasword',[ProfileController::class,'changePassword'])->name('changePassword');
});
//Login admin
